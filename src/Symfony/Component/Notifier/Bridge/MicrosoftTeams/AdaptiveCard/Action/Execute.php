...
use Symfony\Component\Notifier\Bridge\MicrosoftTeams\AdaptiveCard\AssociatedInputs;
 ...
 * @since 1.4
 */
final class Execute extends Action implements JsonSerializable, ActionInterface, ItemInterface, ISelectActionInterface
{
    /**
