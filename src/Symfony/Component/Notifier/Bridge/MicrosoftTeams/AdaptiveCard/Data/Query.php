...
namespace Symfony\Component\Notifier\Bridge\MicrosoftTeams\AdaptiveCard\Data;

use Symfony\Component\Notifier\Bridge\MicrosoftTeams\AdaptiveCard\Default\Data\JsonSerializable;
...
final class Query implements JsonSerializable
{
     ...
     * @psalm-api
     */
    public static function make(string $dataset, ?int $count = null, ?int $skip = null): self
    {
        return new self(
            $dataset,
            $count,
