...
use Symfony\Component\Notifier\Bridge\MicrosoftTeams\AdaptiveCard\Action\Execute;
...
final class Refresh implements JsonSerializable
{
     ...
     * @param  string[]|null $userIds
     */
    public static function make(?Execute $action = null, ?string $expires = null, ?array $userIds = null): self
    {
        return new self(
            $action,
            $expires,
